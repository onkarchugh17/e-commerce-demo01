              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <div className="lg:col-span-3">
                  <Link to="/admin/product-form">
                    <button className="rounded-md mx-8 bg-green-600 my-5 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">
                      Add New Product
                    </button>
                  </Link>
              ...
              <>
                <div>
                      ...
                      <div className="mt-4 flex justify-between">
                        <div>
                          <h3 className="text-sm text-gray-700 font-semibold">
                            <div href={imageUrl + product.thumbnail}>
                              <span
                                aria-hidden="true"
                  ...
                  <Link to={`/admin/product-form/edit/${product.id}`}>
                    <button className="rounded-md bg-indigo-600 my-5 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                      Edit Product
                    </button>
                  </Link>
                </div>
